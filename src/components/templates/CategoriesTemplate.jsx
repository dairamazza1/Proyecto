...
import {Title, Btn1, Buscador, useModulesStore,TablaCategorias} from "../../index"
  ...
  return (
    <Container>
      ...
      <section className="area2">
        ...
        <Btn1 bgcolor={v.colorPrincipal} titulo="nuevo" icono={<v.iconoagregar/>}></Btn1>
      </section>
      <section className="area3"> 
        <Buscador></Buscador>
      </section>
      <section className="main"><TablaCategorias data = {dataModules}/></section>
    </Container>
  );
}
